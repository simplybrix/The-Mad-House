...
public class PlayerMovement : MonoBehaviour
{
    ...
    //declare public float variable speed and set it to 12
    ...
    void Update()
    {
        ...
        {
            //force the Alice to fall to the ground
            velocity.y = -2f;
        }
        ...
        //addition of jumping components
        if(Input.GetButtonDown("Jump") && isGrounded)
        {
            //if jump (Spacebar) is pressed and currently on the ground, allow
